...
\begin{frame}{QR Code}
	\centering
	\qrcode[height=5cm]{https://github.com/ylnt241/eng-project}

	\vspace{1em}

	\text{\href{https://github.com/ylnt241/eng-project}{https://github.com/ylnt241/eng-project}}

	\small{Scan to read the report, view the presentation or inspect the block diagrams}
\end{frame}

\begin{frame}{Thesis Rationale}
	\begin{itemize}
