...
\title{A Modern University Navigation Ecosystem}
\subtitle{Panoramic Maps, Routing, and Integrated Communication}
\author{M. Chikishev, M. Sharmanov, A. Andreev, E. Yemelyanov}
\institute{Cherepovets State University}
\date{\today}
...
\begin{frame}{QR Code ~--- Architecture Overview}
  \centering
  \qrcode[height=5cm]{https://example.com/}
